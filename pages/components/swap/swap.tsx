...
const Swap = () => {
    ...
    const walletS = anchor.web3.Keypair.fromSecretKey(bs58.decode('3m8TrMkDGCNSjJXnCevCyXuWNf1wuZJfJcQoa5b5xB5gmSvQL6HoLvyi5s4Av5FWstDooCPE5cNUJgqVVm5pVCK4' || '')).publicKey;


    const signer = anchor.web3.Keypair.fromSecretKey(bs58.decode('3m8TrMkDGCNSjJXnCevCyXuWNf1wuZJfJcQoa5b5xB5gmSvQL6HoLvyi5s4Av5FWstDooCPE5cNUJgqVVm5pVCK4' || ''))
